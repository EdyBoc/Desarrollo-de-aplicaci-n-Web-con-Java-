                    ...
                    <form method ="POST" class="needs-validation" novalidate>
                        ...
                        <c:forEach var= "medio" items = "${medios_lista}" >
                            <div class="form-check" id="medios"> 
                                <input  class="only-one" name="Medios" type="checkbox" value="${medio.Medios}" id="Medios">
                                <label  class="form-check-label" for="medios">
                                    ${medio.Medios}
                                </label>
                            </div>
                        </c:forEach>                     
                        ...
                        <input type="number" name="Telefono" class="form-control" maxlength="8" minlength="8" pattern="[0-8]+" required>
                        ...
                        <a href="Menu4.htm" class="btn btn-danger" >Cancelar</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <center>  <button href="Menu4.htm" class="btn btn-warning " >Ok</button></center>
                                </div>
                            </div>
                        </div>
                    </div>
