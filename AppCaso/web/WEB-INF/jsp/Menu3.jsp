                ...
                <div style="background: linear-gradient(122deg, rgba(4,100,119,1) 12%, rgba(6,118,140,1) 32%, rgba(7,128,152,1) 39%, rgba(34,193,195,1) 75%);"
                     <div class="card text-white " style="max-width: 95rem; max-height: 45rem;">
                        ...
                        <div align="right" class=" p-1">                           
                            <a href="Login.htm" class="btn btn-danger btn-ms btn-block  active "role="button" aria-pressed="true" >Salir</a>
                        </div>
            ...
            <div  class="d-flex">
                ...
                <div class="card-block col-sm-2 p-1">
                    <div class="card-body " style="background: #ffffff;" >                        
                        ...
                        <center><h5>Banco Mi Pisto</h5></center>
                        <div align="right" class=" p-1">
                            <a href="Agregar3.htm" class="btn btn-danger btn-ms btn-block  active "role="button" aria-pressed="true" >Agregar</a>                           
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    ...
                                    <td>${dato.ESTATUS}</td>
                                    <td>
                                        <a href="Editar3.htm?id=${dato.Id}"class="btn btn-warning"> Modificar
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
                                            <path d="M.102 2.223A3.004 3.004 0 0 0 3.78 5.897l6.341 6.252A3.003 3.003 0 0 0 13 16a3 3 0 1 0-.851-5.878L5.897 3.781A3.004 3.004 0 0 0 2.223.1l2.141 2.142L4 4l-1.757.364L.102 2.223zm13.37 9.019.528.026.287.445.445.287.026.529L15 13l-.242.471-.026.529-.445.287-.287.445-.529.026L13 15l-.471-.242-.529-.026-.287-.445-.445-.287-.026-.529L11 13l.242-.471.026-.529.445-.287.287-.445.529-.026L13 11l.471.242z"/>
                                            </svg>
                                        </a>
                                        <a href="delete3.htm?id=${dato.Id}" class="btn btn-danger"> Elimar
