            ...
            <div class="row justify-content-center">
                <div style="background: linear-gradient(122deg, rgba(4,100,119,1) 12%, rgba(6,118,140,1) 32%, rgba(7,128,152,1) 39%, rgba(34,193,195,1) 75%);"
                     <div class="card text-white " style="max-width: 95rem; max-height: 45rem;">
                        <div class="card-body">
                            <center> <h5 class="card-title text-warning">CASOS DE USOS</h5> </center>
                    ...
                    <div style="background: linear-gradient(122deg, rgba(4,100,119,1) 12%, rgba(6,118,140,1) 32%, rgba(7,128,152,1) 39%, rgba(34,193,195,1) 75%);"
                         <div class="card text-white  " style="max-width: 95rem; max-height: 45rem;">
                            ...
                            <center> <div class="card-header" style="background: rgb(63,94,251);
                                          background: linear-gradient(90deg, rgba(63,94,251,1) 0%, rgba(252,70,107,1) 100%);">BANCO MI PISTO</div></center>
                            <div class="card-body mb-5">

                                <div class="card-header"> Click para ingresar</div>                              
                                <hr class="card text-white">  </hr> 
                                <center> <a href="Login.htm" class="btn btn-danger btn-ms btn-block  active" role="button" aria-pressed="true">Iniciar</a></center>                                 
                                <hr class="card text-white">  </hr> 
